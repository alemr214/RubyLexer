...
def display_tokens(token_list):
    ...
    style = ttk.Style()
    style.configure(
        "BW.TLabel", foreground="#f8f8f2", background="#282a36", font=("Helvetica", 13)
    )
...
def show_error_popup(message):
    ...
    error_label = tk.Label(
        error_popup, text=message, bg="#282a36", fg="#f8f8f2", font=("Consolas", 12)
    )
...
line_number_box = tk.Text(
    ...
    wrap=tk.NONE,
    bg="#44475a",
    # Match background color, text color, and font
    fg="#f8f8f2",
    font=("Consolas", 13),
)
...
text_box = tk.Text(
    text_frame, height=40, width=100, bg="#44475a", fg="#f8f8f2", font=("Consolas", 13)
